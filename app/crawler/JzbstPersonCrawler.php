...
class JzbstPersonCrawler extends BaseCrawler
{
    public $postData = [];
    public $bodyQuery;
    ...
    function __construct($urlRaw)
    {
        ...
        $this->personCollection = $this->mongoConnection->build_info1->jsbst_person;
...
//        print_r($this->postData);
    ...
    function getScrollId()
    {
        ...
        $url = 'http://118.123.173.75:9200/construction_person_index_v1/_search?search_type=scan&scroll=5m&size=' . $this->limit;
...
//        $scrollId = 'c2Nhbjs1OzQxNjkzOTpGQzBMejkyaFJ2LTZaM19UZ2N2VHlnOzQxNjk0MDpGQzBMejkyaFJ2LTZaM19UZ2N2VHlnOzQxNjk0MjpGQzBMejkyaFJ2LTZaM19UZ2N2VHlnOzQxNjk0MTpGQzBMejkyaFJ2LTZaM19UZ2N2VHlnOzQxNjk0MzpGQzBMejkyaFJ2LTZaM19UZ2N2VHlnOzE7dG90YWxfaGl0czo0MjUwMzs=';
        ...
        if (count($persons) > 0) {
            ...
            foreach ($persons as $person) {
                if ($this->personCollection->findOne(['person_id' => ($person['_source']['person_id'])])) {
                    echo "exist " . $person['_source']['person_id'] . "\n";
                    continue;
                }
                $this->personCollection->insertOne($person['_source']);
            }
        } else {
            $this->hasNext = false;
        }
